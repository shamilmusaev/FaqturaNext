-- Allow owners/admins to update their organization's profile, payment, and
-- invoicing default fields. Locked down via SECURITY DEFINER + explicit
-- membership/role check so RLS recursion isn't required.
