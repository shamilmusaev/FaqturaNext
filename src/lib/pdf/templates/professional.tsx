...
const styles = StyleSheet.create({
  page: { fontFamily: 'Helvetica', fontSize: 10, color: '#111111', padding: PAGE_PAD },
  band: {
  ...
  grandValue: { fontFamily: 'Courier', fontWeight: 700 },
  payBox: {
  ...
  payTitle: { color: TEAL[800], fontSize: 9, fontWeight: 700, marginBottom: 6, letterSpacing: 0.5 },
